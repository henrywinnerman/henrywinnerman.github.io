...
- **Integration Guides** — Step-by-step implementation with code samples
- **User Guides** — Task-oriented docs for developers and end-users
...
- [Termii SMS & OTP API](https://github.com/henrywinnerman/technical-writing-portfolio/blob/main/api-documentation/termii-sms-api.md)

#### User Guides
- [Getting Started with Postman](https://github.com/henrywinnerman/technical-writing-portfolio/blob/main/user-guides/postman-api-testing-guide.md)
- [GitHub Actions for Documentation](https://github.com/henrywinnerman/technical-writing-portfolio/blob/main/user-guides/github-actions-documentation-guide.md)
...
**Writing:** Markdown, Technical English, Docs-as-Code

**Technologies I Document:** JavaScript, TypeScript, PHP, Python, React, Next.js, Laravel
